...
Inherit the theme's fonts rather than using the default for events and event views.

== Description ==

Activating this extension will override the default event and event view fonts by inheriting the theme fonts.
